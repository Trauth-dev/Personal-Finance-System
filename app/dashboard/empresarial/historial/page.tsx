...
export default function HistorialEmpresarialPage() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `historial_empresarial_${new Date().toISOString().split("T")[0]}.csv`)
  ...
  if (!perfilActual) {
    return (
      <div>
        <DashboardHeader title="Historial Empresarial" description="Registro de movimientos empresariales" />
        <div className="p-6">
  ...
  return (
    <div>
      <DashboardHeader title="Historial Empresarial" description="Registro completo de movimientos empresariales" />
                ...
                {isLoading ? (
                  ...
                  <>
                    ...
                    {ingresos.length === 0 && egresos.length === 0 && (
                      <Card className="glass-effect border-border/50">
                        <CardContent className="py-12 text-center text-muted-foreground">
                          No hay transacciones registradas para este perfil empresarial
                        </CardContent>
                      </Card>
                    )}
                  </>
      ...
      <Dialog open={editId !== null} onOpenChange={() => setEditId(null)}>
        <DialogContent className="glass-effect">
          <DialogHeader>
            ...
            <DialogDescription>Modifica los datos de la transacción empresarial</DialogDescription>
          </DialogHeader>
          {editData && (
            <div className="space-y-4">
              {editType === "ingreso" ? (
