...
import { Heart, PiggyBank, ShoppingBag, Home, CreditCard, Smile, GraduationCap, Star, TrendingUp, AlertTriangle, CheckCircle2, AlertCircle } from 'lucide-react'
...
const CATEGORIAS_CONFIG = {
  "Donación": { icon: Heart, color: "from-pink-500 to-rose-500", textColor: "text-pink-600", bgColor: "bg-pink-50", borderColor: "border-pink-300" },
  "Ahorro 2025": { icon: PiggyBank, color: "from-green-500 to-emerald-500", textColor: "text-green-600", bgColor: "bg-green-50", borderColor: "border-green-300" },
  "Gastos Varios": { icon: ShoppingBag, color: "from-purple-500 to-violet-500", textColor: "text-purple-600", bgColor: "bg-purple-50", borderColor: "border-purple-300" },
  "Gastos Vivienda": { icon: Home, color: "from-orange-500 to-amber-500", textColor: "text-orange-600", bgColor: "bg-orange-50", borderColor: "border-orange-300" },
  "Pago Deudas": { icon: CreditCard, color: "from-red-500 to-rose-500", textColor: "text-red-600", bgColor: "bg-red-50", borderColor: "border-red-300" },
  "Disfrute": { icon: Smile, color: "from-yellow-500 to-amber-500", textColor: "text-yellow-600", bgColor: "bg-yellow-50", borderColor: "border-yellow-300" },
  "Educación": { icon: GraduationCap, color: "from-blue-500 to-cyan-500", textColor: "text-blue-600", bgColor: "bg-blue-50", borderColor: "border-blue-300" },
  "Sueños": { icon: Star, color: "from-indigo-500 to-purple-500", textColor: "text-indigo-600", bgColor: "bg-indigo-50", borderColor: "border-indigo-300" },
  "Libertad Financiera": { icon: TrendingUp, color: "from-teal-500 to-cyan-500", textColor: "text-teal-600", bgColor: "bg-teal-50", borderColor: "border-teal-300" },
}
...
export function PresupuestoDetalladoTerciarioClient({
  ...
  console.log("[v0] Categorías activas en terciario:", categoriasActivas)
        ...
        <CardContent>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {categoriasActivas.map((categoria) => {
              ...
              return (
                <Card key={categoria.nombre} className={`${config.bgColor} border-2 ${config.borderColor} shadow-lg overflow-hidden`}>
                      ...
                      <div className="space-y-2">
                        ...
                        {top3.map((egreso, idx) => (
                          <div key={idx} className="flex items-center justify-between p-2 rounded-lg bg-white border border-slate-200">
                            ...
                            <p className="text-sm font-bold text-slate-800 ml-2">{formatGuaranies(Number(egreso.monto))}</p>
                          </div>
                        ))}
