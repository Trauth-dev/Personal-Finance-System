...
-- 6. Agregar campo de ultima_actividad a clientes para tracking
...
-- 9. Agregar RLS policies para los nuevos campos
-- (Las policies existentes ya cubren user_id, solo necesitamos asegurar que funcionen)
...
COMMENT ON COLUMN crm_clientes.ultima_actividad IS 'Fecha de la ultima actividad relacionada con el cliente';
